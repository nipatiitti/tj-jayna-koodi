...
export const Team = () => (
  <div className="bg-gray-900 py-24 sm:py-32" id="tiimi">
    <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
      <div className="mx-auto max-w-2xl">
        <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">AI:n artisaanit</h2>
        <p className="mt-4 text-lg leading-8 text-gray-400">
          Vaikka tiimimme on nuori, on meillä vahvaa kokemusta ja taitoa tekoälyn kehittämisessä.
        </p>
      </div>
      <ul
        role="list"
